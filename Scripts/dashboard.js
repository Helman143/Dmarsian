        ...
        .then(text => {
            ...
            try {
                ...
                if (duesTableBody) {
                    ...
                    errRow.innerHTML = '<td colspan="9" style="text-align:center;color:#fff;">Error parsing dues</td>';
            ...
            if (data.status === 'success') {
                    ...
                    if (data.dues.length === 0) {
                        ...
                        data.dues.forEach(due => {
                            ...
                            row.innerHTML = `
                                ...
                                <td>${due.contact}</td>
                                <td>
                                    <span title="Count: ${due.reminder_count || 0}">${lastSent}</span>
                                </td>
                                <td>
                ...
                if (duesTableBody) {
                    const noDataRow = document.createElement('tr');
                    noDataRow.innerHTML = '<td colspan="9" style="text-align: center; color: #fff;">' + (data.message || 'No dues found') + '</td>';
                    duesTableBody.innerHTML = '';
                    duesTableBody.appendChild(noDataRow);
                }
            }
...
// Initialize dashboard behaviors (dues table, charts, reminder buttons)
