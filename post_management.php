...
<head>
    ...
    <title>Post Management | D'Marsians Taekwondo Gym</title>
...
<body>
    <div class="container-fluid">
        <!-- Sidebar -->
        <?php $active = 'posts'; include 'partials/sidebar.php'; ?>
            ...
            <div class="filters">
                <div class="filter-dropdown">
                    <select id="year-filter" onchange="filterPosts()">
                        <?php
                        // Only show 2026
                        $selected_2026 = ($year_filter == 2026 || $year_filter === null) ? 'selected' : '';
                    ...
                    <?php foreach ($posts as $post): ?>
                        ...
                        if ($img_path_value !== null && $img_path_value !== '' && trim($img_path_value) !== '') {
                            ...
                            $log_entry = json_encode([
                                'id' => 'log_' . time() . '_' . uniqid(),
                                'timestamp' => round(microtime(true) * 1000),
                                'location' => 'post_management.php:295',
                        ...
                        if (!$has_image) {
                            ...
                            $log_entry = json_encode([
                                'id' => 'log_' . time() . '_' . uniqid(),
                                'timestamp' => round(microtime(true) * 1000),
                                'location' => 'post_management.php:310',
